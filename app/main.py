...
def root():
    ...
    <head>
      ...
      <style>
        ...
        h1{font-size:42px;line-height:1.15;margin:18px 0 8px}
        p{font-size:18px;opacity:.92}
        ...
        .primary{background:#5b8cff;color:white}
        .ghost{background:transparent;border:1px solid #3a4a7a;color:#cdd6f4}
